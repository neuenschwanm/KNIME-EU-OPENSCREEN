 ...
 */
public class FASTAWriterNodePlugin extends Plugin {
    // The shared instance.
    private static FASTAWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public FASTAWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FASTAWriterNodePlugin getDefault() {
        return plugin;
    }
