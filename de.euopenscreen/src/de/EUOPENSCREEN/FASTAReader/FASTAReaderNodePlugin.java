 ...
 * @author Marc Wippich
 */
public class FASTAReaderNodePlugin extends Plugin {
    // The shared instance.
    private static FASTAReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public FASTAReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FASTAReaderNodePlugin getDefault() {
        return plugin;
    }
