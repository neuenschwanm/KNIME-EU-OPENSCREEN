 ...
 */
public class FastTanimotoNodePlugin extends Plugin {
    // The shared instance.
    private static FastTanimotoNodePlugin plugin;

    /**
     * The constructor.
     */
    public FastTanimotoNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FastTanimotoNodePlugin getDefault() {
        return plugin;
    }
