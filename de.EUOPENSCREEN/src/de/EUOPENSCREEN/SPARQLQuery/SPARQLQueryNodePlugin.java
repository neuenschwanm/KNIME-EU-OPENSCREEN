 ...
 */
public class SPARQLQueryNodePlugin extends Plugin {
    // The shared instance.
    private static SPARQLQueryNodePlugin plugin;

    /**
     * The constructor.
     */
    public SPARQLQueryNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SPARQLQueryNodePlugin getDefault() {
        return plugin;
    }
